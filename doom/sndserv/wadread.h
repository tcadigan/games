...
// -----------------------------------------------------------------------------
//
// $Id: wardread.h,v 1.3 1997/01/30 19:54:23 b` Exp $
//
// Copyright (C) 1993-1996 by id Software, Inc.
//
// This source is available for distribution and/or modification
// only under the terms of the DOOM Source Code Liscense as
// pulished by id Software. All rights reserved.
//
...
// Must be called before calls to loadlump() of getsfx().
void openwad(char *wadname);

// Gets a sound effect from the ad file. The pointer points to the
